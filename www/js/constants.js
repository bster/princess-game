...
export const GROUND_ACCEL = 0.4;
export const GROUND_DECEL = 0.35;
export const TURN_DECEL = 0.7; // applied when input opposes velocity (skid)
...
export const APEX_GRAVITY_MOD = 0.6;
...
export const C = {
  ...
  // Power-up colors
  firePrimary: '#FF4500',
  fireSecondary: '#FFD700',
  flightPrimary: '#87CEEB',
  flightSecondary: '#FFFFFF',
  shieldPrimary: '#4169E1',
  shieldSecondary: '#87CEFA',
  growthPrimary: '#32CD32',
  growthSecondary: '#ADFF2F',
};
...
export const PARALLAX_MID_SPEED = 0.4; // mid layer scroll multiplier
